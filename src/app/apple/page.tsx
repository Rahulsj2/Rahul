  ...
  if (!envPass) {
    return (
      ...
      >
        ...
        <p className="mt-3">
          Add one line to <code className="rounded bg-[#f5f4f0] px-1.5 py-0.5 font-mono text-[13px]">.env.local</code>{" "}
        ...
        <p className="mt-4 text-[13px] text-[#9a9992]">Then restart <code className="font-mono">npm run dev</code>.</p>
      </div>
    );
  }
